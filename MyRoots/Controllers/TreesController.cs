...
namespace MyRoots.Controllers
{
    public class TreesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TreeId,TreeName,DateOfCreation")] Tree tree)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TreeId,TreeName,DateOfCreation")] Tree tree)
        {
            if (ModelState.IsValid)
            {
